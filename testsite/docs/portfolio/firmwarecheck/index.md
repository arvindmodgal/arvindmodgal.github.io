...
-   :material-sitemap: **Information Architecture**

    ---

    Redesigned documentation around user goals and workflows instead of product features.
...
-   :material-account-group: **User Experience**

    ---

    Simplified complex cybersecurity concepts for different user groups.
...
-   :material-code-braces: **Documentation Engineering**

    ---

    Built documentation using a modern docs-as-code workflow.
