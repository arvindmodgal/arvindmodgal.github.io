...
## 📘 [FirmwareCheck User Guide](firmwarecheck/index.md)

**Type:** End-user software documentation  
**Audience:** Product security engineers, compliance officers, device manufacturers  
**Domain:** IoT security, firmware analysis, compliance (ETSI 303 645, ISO 21434, IEC 62443)  
**Tools:** Markdown, Confluence (drafts), Adobe RoboHelp (publishing)
...
**Audience:** Technical writing team, developers, QA engineers, project managers  
**Domain:** Enterprise banking software  
**Tools:** Microsoft Word, Adobe RoboHelp (original); Confluence (migrated)
...
- Sentence case heading standard with proper noun exceptions
- Common grammar errors table with corrections
