...
Use consistent terminology throughout the documentation. Consistent word choices reduce ambiguity, improve searchability, and help users recognize familiar concepts.

Always use the same term to describe the same concept.

## General guidelines

Follow these guidelines when choosing terminology:

- Use the terminology that appears in the product interface.
- Prefer simple, commonly understood words.
- Use industry-standard terms when appropriate.
...
Define important product-specific terms early in the documentation.
...
!!! info "Example"
    ...
    The FirmwareCheck User Guide consistently uses **Device**, **Firmware**, and **Assessment** throughout the documentation, helping users become familiar with the product vocabulary.

## Key takeaways

- Use one term for one concept.
- Match the product's UI labels.
