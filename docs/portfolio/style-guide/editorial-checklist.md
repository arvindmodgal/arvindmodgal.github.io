...
Use this checklist before publishing documentation to ensure it is accurate, consistent, and ready for users.
...
!!! info "Example"
    ...
    Before publishing the FirmwareCheck User Guide, each topic was reviewed for consistency, hyperlink accuracy, formatting, and navigation to ensure a predictable user experience.
